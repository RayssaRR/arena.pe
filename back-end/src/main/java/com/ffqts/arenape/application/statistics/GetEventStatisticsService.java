package com.ffqts.arenape.application.statistics;
...
import com.ffqts.arenape.presentation.dto.statistics.TicketSalesPeriodDTO;
import com.ffqts.arenape.presentation.dto.statistics.WeeklySalesDTO;
...
@Service
public class GetEventStatisticsService implements IGetEventStatistics {
    ...
    @Override
    public EventStatisticsDTO get(UUID eventId) {
